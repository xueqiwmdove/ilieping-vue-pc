		...
		<div class="certificate-content reset ">
			<div class="form-group">
				<div class="uploadFile">
					...
					<input :disabled='flag' class="el-icon-upload" type="file" ref="fileTag" @change="getFile($event)" id='file'
					 accept="image/bmp,image/jpg,image/png,image/jpeg" action="" />
				</div>
			</div>
		</div>
		<!-- 上传列表 -->
...
<style scoped>
	...
	.ic_atta {
		...
		margin-right: 6px;
		display: inline-block;
		background: url(../../assets/img/staff/ic_atta.png);
		background-size: 100%;
	}
</style>
