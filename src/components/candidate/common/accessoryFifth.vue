      ...
      <div v-if="dataList.length==0" class="noOps">
        ...
        <p>尚无附件信息</p>
         <el-upload
          ...
          :file-list="fileList"
          >
          <el-button style="background-color:#F95714;border-radius:4px;width:220px;height:40px;color:#fff"  v-show="StepsDataStatus!=0">上传附件</el-button>
          ...
          <div class="file_text">
            <div class="file" v-for="(item,index) in dataList" :key="index">
              ...
              <div>
                ...
                <i @click="deletefile(item)" class="delete" v-if="item.type !=3" v-show="StepsDataStatus!=0">删除</i>
              </div>
